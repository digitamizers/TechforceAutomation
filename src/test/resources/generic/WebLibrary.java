 ...
 * ######################################################################################################
 */
    public static Boolean SetTextAndEnter(String ObjectXpath,String Value)
    {
        Boolean stepStatus = true;
        try
        {
            ...
            driver.findElement(By.xpath(ObjectXpath)).sendKeys(Keys.ENTER);
        }
        catch (Exception e)
        {
            stepStatus = false;
 ...
 */
    ...
    public static Boolean SetTextAndTab(String ObjectXpath,String Value)
    {
        Boolean stepStatus = true;
        try
        {
 ...
 */
	 ...
	 * ######################################################################################################
	 */
		public static Boolean SelectOPtionByTextAndTab(String ObjectXpath,String Option)
		{
			Boolean stepStatus = true;
	        try
	        {
	        	Highlight(ObjectXpath);
	        	String ObjectXpath1 = ObjectXpath + "/option[text()='" + Option + "']";
